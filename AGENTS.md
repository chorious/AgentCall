...
- v6.7 hardens the control plane internals; v6.7.1 fixes bounded daemon start waiting, SQLite sequence recovery, and full board store-backed event reads.
