...
pub(crate) fn runtime_health(state: &AppState) -> serde_json::Value {
    ...
    serde_json::json!({
        ...
        "store_writer_threads": state.store.writer_threads(),
        "configured_store_writer_threads": state.config.store_writer_threads,
        "store_parallel_writes": state.store.supports_parallel_writes(),
